...
<div class="row pt-3">
	<div class="col-sm-6">
		<div id="titulo" class="mt-3">
			<h3><i class="plusTitulo mb-2" data-feather="list" ></i> Lista de Productos
			</h3>
		</div>
	</div>
	<div id="agregarProducto" class="col-sm-6 text-right">
		<a href="AgregarProducto" class="btn btn-link"><i stop-color data-feather="plus"></i>Agregar Producto</a>
	</div>
</div>
<div class="row p-3">
	<div id="tDatos" class="col-sm-12 p-3">
		<div class="table-responsive" id="tablaListaProductos">
			<table id="tListaProductos" class="table table-sm table-hover table-bordered">
