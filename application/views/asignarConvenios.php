...
<form method="post" accept-charset="utf-8" action="agregarConvenio" class="" id="agregarConvenio" enctype="multipart/form-data">
	<div class="row pt-3 pl-3">
		...
		<div class="form-group col-sm-5 pt-3">
			...
			<input type="text" class="form-control" id="inputMarco" minlength="1" placeholder="Seleccione un Marco" name="inputMarco" disabled>
		...
		<div class="form-group col-sm-6 pt-3">
			<label for="idComunas">Comunas</label>
			<select id="selectComunas" class="selectpicker" data-actions-box="true" data-width="100%" data-live-search="true" title="Seleccione una Comuna">
			  <?php
				if($comunas)
				{
