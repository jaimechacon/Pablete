				        ...
				        foreach ($instituciones as $institucion): ?>
				  			<tr>
						        ...
						        <td class="text-center align-middle registro botonTabla">
					        		...
					        		<a id="view_<?php echo $institucion['id_institucion']; ?>" class="edit" type="link" href="<?php echo base_url().'Producto/ingresosStockInstitucion/?idProducto='.$idProducto.'&idInstitucion='.$institucion['id_institucion']; ?>" data-id="<?php echo $institucion['id_institucion']; ?>" data-nombre="<?php echo $institucion['nombre']; ?>">
