				        ...
				        foreach ($marcos as $marco): ?>
				  			<tr>
					        	...
					        	<td class="text-center align-middle registro botonTabla">
						        	...
						        	<a id="trash_<?php echo $marco['id_grupo_marco']; ?>" class="trash" href="#" data-id="<?php echo $marco['id_grupo_marco']; ?>" data-institucion="<?php echo $marco['institucion']; ?>" data-programa="<?php echo $marco['programa']; ?>" data-toggle="modal" data-target="#modalEliminarMarco">
