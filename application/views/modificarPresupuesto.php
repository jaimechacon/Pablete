...
#	var_dump($presupuesto['archivo']);
?>
<div class="row pt-3">
	<div class="col-sm-6">
		<div id="titulo" class="mt-3">
			<h3 class="pl-3"><i class="plusTitulo mb-2" data-feather="list" ></i> Modificar Presupuesto
			</h3>
		</div>
	</div>
</div>
			...
			if($cuenta['id_cuenta'] == "6" || $cuenta['id_cuenta'] == "3" || $cuenta['id_cuenta'] == "4" || $cuenta['id_cuenta'] == "5")
			{
				...
				{?>
					...
					<div class="form-group col-sm-6">
						...
						<input type="number" class="form-control" id="inputPresupuesto<?php echo $cuenta['id_cuenta']; ?>" minlength="1" placeholder="Ingrese un Presupuesto para <?php echo $cuenta['nombre'] ?>" name="inputPresupuesto<?php echo $cuenta['id_cuenta']; ?>" value="<?php if(isset($presupuesto['presupuesto_'.$cuenta['id_cuenta']])): echo $presupuesto['presupuesto_'.$cuenta['id_cuenta']]; endif; ?>"/>
					</div>
